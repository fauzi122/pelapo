        ...
        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <form method="post" action="/master/port" class="form-material m-t-40" enctype="multipart/form-data">
                                    @csrf
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" id="example-text-input" name="nm_port" value="{{ old('nm_port') }}">
                                                        @error('nm_port')
