    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="example-text-input" class="form-label">Bulan</label>
                    <input class="form-control lihat_bulan" type="date" id="" name="bulan"
                ...
                <div class="mb-3">
                    <label for="example-text-input" class="form-label">Volume</label>
                    <input class="form-control lihat_volume" type="text" id="" name="volume" readonly>
                </div>
            ...
            <form method="post" action="/simpan_pengolahan_minyak_bumi_distribusi" class="form-material m-t-40"
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="hidden" id="" name="status" value="-">
        ...
        <div class="modal-content">
            ...
            <form method="post" action="/update_pengolahan_minyak_bumi_distribusi" class="form-material m-t-40"
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="example-text-input" class="form-label">Bulan</label>
                        <input class="form-control" type="date" id="bulan_distribusi" name="bulan"
                            value="{{ old('bulan') }}" required>
                        @error('bulan')
                            <div class="form-group has-danger mb-0">
                                <div class="form-control-feedback">{{ $message }}</div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" id="sektor_pengolahanDistribusi" name="sektor">
                        @error('sektor')
                            <div class="form-group has-danger mb-0">
                                <div class="form-control-feedback">{{ $message }}</div>
                            </div>
                    ...
                    <div class="mb-3">
                        <label for="example-text-input" class="form-label">Volume</label>
                        <input class="form-control" type="text" id="volume_pengolahanDistribusi" name="volume">
                        @error('volume')
                            <div class="form-group has-danger mb-0">
                                <div class="form-control-feedback">{{ $message }}</div>
                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="example-text-input" class="form-label">Sektor</label>
                    <input class="form-control lihat_sektor" type="text" id="" name="sektor"
                        readonly>
                </div>

                <div class="mb-3">
                    <label for="example-text-input" class="form-label">Volume</label>
                    <input class="form-control lihat_volume" type="text" id="" name="volume"
                        readonly>
                </div>
