                            ...
                            <div class="table-responsive">
                                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                    ...
                                    <tr>
                                        ...
                                        <td><form action="/hapus_bulan_lpg/{{ $data->bulan }}" method="post" class="d-inline">
                                                    @method('delete')
                                                    @csrf
                                            ...
                                            <form action="/submit_bulan_penjualan_lpg/{{$data->bulan }}" method="post" class="d-inline" data-id="{{ $data->bulan }}">
                                                @method('PUT')
                                                @csrf
                                        ...
                                        <td><form action="/hapus_bulan_lpg/{{ $data->bulan }}" method="post" class="d-inline">
                                            ...
                                            <a href="/niaga/lpg/show/{{$id}}/penjualan" class="btn btn-sm btn-info"><i class="bx bx-edit" title="Revisi"></i></a>
                                        </td>
                                        @endif
                                </tr>
                                        @endforeach
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <button type="button" class="btn btn-primary waves-effect waves-light"
                                        ...
                                        data-bs-target="#inputPasokanLPG">Buat Laporan</button>
                                    <button type="button" class="btn btn-success waves-effect waves-light"
                                        data-bs-toggle="modal" data-bs-target="#excelPasokanLPG">Import Excel</button>
                                    <!-- Include modal content -->
                                </div>
                            </div>
                        </div>  
                            ...
                            <div class="table-responsive">
                                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                    ...
                                    <tr>
                                        ...
                                        @if ($data->status_tertinggi == 1)
                                        <td><form action="/hapus_bulan_pasokanLPG/{{ $data->bulan }}" method="post" class="d-inline">
                                                    @method('delete')
                                                    @csrf
                                                    <button type="button" class="btn btn-sm btn-danger"  onclick="hapusData($(this).closest('form'))" disabled>
                                                        <i class="bx bx-trash-alt" title="Hapus data"></i>
                                            ...
                                            <form action="/submit_bulan_pasokan_lpg/{{$data->bulan }}" method="post" class="d-inline" data-id="{{ $data->bulan }}">
                                                @method('PUT')
                                                @csrf
                                                    <button type="button" class="btn btn-sm btn-success" onclick="kirimData($(this).closest('form'))" disabled>
                                                        <i class="bx bx-paper-plane" title="Kirim data"></i>
                                        ...
                                        <td><form action="/hapus_bulan_pasokanLPG/{{ $data->bulan }}" method="post" class="d-inline">
                                            ...
                                            <a href="/niaga/lpg/show/{{$id}}/pasok" class="btn btn-sm btn-info"><i class="bx bx-edit" title="Revisi"></i></a>
                                        </td>
                                        @endif
                                </tr>
                                        @endforeach
