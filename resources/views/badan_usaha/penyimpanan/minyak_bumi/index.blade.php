            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18"> Penyimpanan Minyak Bumi</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Tables</a></li>
                                <li class="breadcrumb-item active"> Penyimpanan Minyak Bumi</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="d-flex justify-content-end mb-3">
                                ...
                                <div>
                                    <button type="button" class="btn btn-primary waves-effect waves-light"
                                        onclick="produk(); provinsi(); kab_kota();" data-bs-toggle="modal"
                                        data-bs-target="#myModal">Buat Laporan</button>
                                    <button type="button" class="btn btn-success waves-effect waves-light"
                                        data-bs-toggle="modal" data-bs-target="#excelpmb">Import Excel</button>
                                    ...
                                    <tbody>
                                        @foreach ($pm as $data)
                                            ...
                                            <tr>
                                                ...
                                                <td><b><a href="/penyimpanan-minyak-bumi/show/{{ $id }}">{{ dateIndonesia($data->bulan) }}<i
