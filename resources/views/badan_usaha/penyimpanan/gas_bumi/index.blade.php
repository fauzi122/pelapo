                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active"> Penyimpanan Gas Bumi</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="d-flex justify-content-end mb-3">
                                ...
                                <div>
                                    ...
                                    <button type="button" class="btn btn-success waves-effect waves-light"
                                        data-bs-toggle="modal" data-bs-target="#excelpggb">Import Excel</button>
                                            ...
                                            <tr>
                                                ...
                                                @if ($data->status_tertinggi == 1)
                                                    <td>
                                                        ...
                                                        <form action="/submit_bulan_pggb/{{ $data->bulan }}" method="post"
                                                ...
                                                @else
                                                    <td>
                                                        ...
                                                        <a href="/penyimpanan-gas-bumi/show/{{ $id }}"
