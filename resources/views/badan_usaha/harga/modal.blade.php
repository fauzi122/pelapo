        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select produk satuan" name="satuan_produk" id="satuan">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="example-text-input" class="form-label">Provinsi</label>
                    <select class="form-select" name="provinsi" id="provinsi_pasokan">
                        <option>Pilih Provinsi</option>
                    </select>
                    @error('provinsi')
                        <div class="form-group has-danger mb-0">
                ...
                <div class="mb-3">
                    <label for="example-text-input" class="form-label">Kabupaten / Kota</label>
                    <select class="form-select" name="kabupaten_kota" id="kab_pasokan">
...
<div id="edit-hargabbm" class="modal fade" tabindex="-1" aria-labelledby="editjholbxLabel" aria-hidden="true" data-bs-scroll="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="/update_pasok_lng/" class="form-material m-t-40" enctype="multipart/form-data" id="form_hargabbm">
            @method('PUT')
            @csrf
            <div class="modal-body">
                <div class="mb-3">
