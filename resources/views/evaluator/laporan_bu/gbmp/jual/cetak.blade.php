...
<table class="table table-light" style="font-size: 12px; border-collapse: collapse; border: 1px solid black;">
	...
	<tr>
		...
		<th style="border: 1px solid black;">JUMLAH HARI PENYALURAN</th>
		<th style="border: 1px solid black;">GHV</th>
		<th style="border: 1px solid black;">VOLUME MMBTU</th>
		<th style="border: 1px solid black;">VOLUME MSCF</th>
		<th style="border: 1px solid black;">VOLUME M3</th>
	...
	@foreach($result as $pgb)
		<tr>
			...
			<td style="border: 1px solid black;">{{ $pgb->konsumen }}</td>
			<td style="border: 1px solid black;">{{ $pgb->jumlah_hari_penyaluran }}</td>
			<td style="border: 1px solid black;">{{ $pgb->ghv }}</td>
			<td style="border: 1px solid black;">{{ $pgb->volume_mmbtu }}</td>
			<td style="border: 1px solid black;">{{ $pgb->volume_mscf }}</td>
			<td style="border: 1px solid black;">{{ $pgb->volume_m3 }}</td>
			<td style="border: 1px solid black;">{{ $pgb->harga }}</td>
