                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <a href="{{url('laporan/jual/gbmp/periode').'/'.\Illuminate\Support\Facades\Crypt::encrypt($per->badan_usaha_id)}}"
                                        ...
                                        <div class="modal fade" id="modal-update-status" data-bs-backdrop="static"
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ url('/laporan/jual/gbmp/update-revision-all') }}"
                                    ...
                                    <table id="datatable-buttons"
                                        ...
                                        @foreach ($query as $pgb)
                                            <tr>
                                                        ...
                                                        <div class="modal fade" id="modal-update" data-bs-backdrop="static"
                                                            ...
                                                            <div class="modal-dialog modal-lg">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="{{ url('/laporan/jual/gbmp/update-revision') }}"
                                                                          method="post" id="updateStatusForm"
                                                                          enctype="multipart/form-data">
                                                                        @csrf
                                                ...
                                                <td>{{ $pgb->sektor }}</td>
                                                <td>{{ $pgb->konsumen }}</td>
                                                <td>{{ $pgb->jumlah_hari_penyaluran }}</td>
                                                <td>{{ $pgb->ghv }}</td>
            ...
            $('.btn-selesai-status').on('click', function () {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ url('/laporan/jual/gbmp/selesai-periode-all') }}',
                            type: 'POST',
                            data: {
                                _token: '{{ csrf_token() }}',
        ...
        document.querySelectorAll('.btn-selesai').forEach(function(button) {
            ...
            button.addEventListener('click', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ url('/laporan/jual/gbmp/selesai-periode') }}',
                            type: 'POST',
                            data: {
                                _token: '{{ csrf_token() }}',
