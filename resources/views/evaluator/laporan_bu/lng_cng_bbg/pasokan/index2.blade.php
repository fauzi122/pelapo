        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Laporan Pasokan LNG/CNG/BBG</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Tabel</a></li>
                            <li class="breadcrumb-item active">Laporan Pasokan LNG/CNG/BBG</li>
                        </ol>
                    </div>
                </div>
            </div>
							...
							<div class="modal fade" id="modal-filter" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
							  <div class="modal-dialog modal-lg">
								<div class="modal-content">
									...
									<form action="{{ url('/laporan/pasok/lng-cng-bbg') }}" method="post" id="myform" enctype="multipart/form-data">
									@csrf
                                    ...
                                    <table id="datatable-buttons" class="table table-bordered nowrap w-100">
                                        ...
                                        <tbody>
											...
											<tr>
												...
												<td>{{ $data->kategori_pemasok }}</td>
												<td>{{ $data->volume }}</td>
												<td>{{ $data->satuan }}</td>
												<td>{{ $data->harga_gas }}</td>
												<td>{{ $data->petugas }}</td>
												<td>{{ $data->catatan }}</td>
												<td>
													<!-- Button trigger modal -->
													...
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															...
															<form action="{{ url('/laporan/pasok/lng-cng-bbg/update-revision/'.$data->id) }}" method="post" id="myform" enctype="multipart/form-data">															
															@csrf
															@method('put')
															<div class="modal-body">
