...
<table class="table table-light" style="font-size: 12px; border-collapse: collapse; border: 1px solid black;">
	...
	<tr>
		...
		<th style="border: 1px solid black;">SATUAN</th> <!-- Add SATUAN -->
		...
		<th style="border: 1px solid black;">BIAYA NIAGA</th> <!-- Add BIAYA NIAGA -->
	...
	@foreach($result as $pgb)
		<tr>
			...
			<td style="border: 1px solid black;">{{ $pgb->produk }}</td> <!-- Change sektor to produk -->
			<td style="border: 1px solid black;">{{ $pgb->provinsi }}</td>
			<td style="border: 1px solid black;">{{ $pgb->kabupaten_kota }}</td>
			<td style="border: 1px solid black;">{{ $pgb->konsumen }}</td> <!-- Add KONSUMEN -->
			<td style="border: 1px solid black;">{{ $pgb->sektor }}</td>
			<td style="border: 1px solid black;">{{ $pgb->volume }}</td>
			<td style="border: 1px solid black;">{{ $pgb->satuan }}</td> <!-- Add SATUAN -->
			<td style="border: 1px solid black;">{{ $pgb->biaya_kompresi }}</td> <!-- Change biaya_perolehan to biaya_kompresi -->
			<td style="border: 1px solid black;">{{ $pgb->biaya_pengangkutan }}</td> <!-- Add BIAYA PENGANGKUTAN -->
			<td style="border: 1px solid black;">{{ $pgb->biaya_penyimpanan }}</td>
			<td style="border: 1px solid black;">{{ $pgb->biaya_niaga }}</td> <!-- Add BIAYA NIAGA -->
