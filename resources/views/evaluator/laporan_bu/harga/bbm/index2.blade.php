        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Laporan Harga BBM JBU</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Tabel</a></li>
                            <li class="breadcrumb-item active">Laporan Harga BBM JBU</li>
                        </ol>
                    </div>
                </div>
            </div>
							...
							<div class="modal fade" id="modal-filter" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
							  <div class="modal-dialog modal-lg">
								<div class="modal-content">
									...
									<form action="{{ url('/laporan/harga-bbm') }}" method="post" id="myform" enctype="multipart/form-data">
									@csrf
									<div class="modal-body">
										...
										<select name="provinsi" id="provinsi" class="form-control">
											...
											@foreach ($provinsi as $data_provinsi)
												<option class="text-center" value="{{ $data_provinsi['provinsi'] }}">{{ $data_provinsi['provinsi'] }}</option>
											@endforeach
										</select>
                                    ...
                                    <table id="datatable-buttons" class="table table-bordered nowrap w-100">
                                        ...
                                        <tbody>
											...
											<tr>
												...
												<td>{{ $data->provinsi }}</td>
												<td>{{ $data->volume }}</td>
												<td>{{ $data->biaya_perolehan }}</td>
												<td>{{ $data->biaya_distribusi }}</td>
												...
												<td>
													...
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															...
															<form action="{{ url('/laporan/harga-bbm/update-revision/'.$data->id) }}" method="post" id="myform" enctype="multipart/form-data">															
															@csrf
															@method('put')
															<div class="modal-body">
