                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div>
                                    <a href="{{url('laporan/produksi/mb')}}" class="btn btn-danger btn-sm btn-rounded"><i class='bx bx-arrow-back'></i> Kembali</a>
                                </div>
                                </div>
                            </div>
                            <div class="card-body">
                                            ...
                                            <table id="datatable-buttons" class="table table-bordered nowrap w-100">
                                                ...
                                                @foreach ($query as $data)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <b><a href="/laporan/produksi/mb/{{ $id }}">{{ dateIndonesia($data->bulan) }}
                                                                    <i
                                                                            class="bx bx-check"
                                                                ...
                                                                <div class="modal fade" id="modal-update" data-bs-backdrop="static"
                                                                    ...
                                                                    <div class="modal-dialog modal-lg">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <form action="{{ url('/laporan/produksi/mb/update-revision-all') }}"
            ...
            button.addEventListener('click', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ url('/laporan/produksi/mb/selesai-periode-all') }}',
                            type: 'POST',
                            data: {
                                _token: '{{ csrf_token() }}',
                                p: p,
