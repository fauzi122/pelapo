									...
									<div class="modal-dialog modal-dialog-centered">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form id="cetakForm" action="{{url('laporan/penyimpanan/gb/cetak-periode')}}" method="post" >
													@csrf
													<div>
														<div class="mb-3">
										...
										<table id="datatable-buttons" class="table table-bordered nowrap w-100">
											...
											@foreach($perusahaan as $per)
												<tr>
													...
													<td><a href="{{url('laporan/penyimpanan/gb/periode').'/'. \Illuminate\Support\Facades\Crypt::encrypt($per->id_perusahaan) }}" class="btn btn-primary btn-rounded btn-sm"><i class="bx bx-show"></i> Lihat </a></td>
