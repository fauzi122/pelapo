                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div>
                                    <a href="{{url('laporan/produksi/gb')}}" class="btn btn-danger btn-sm btn-rounded"><i class='bx bx-arrow-back'></i> Kembali</a>
                                </div>
                                </div>
                            </div>
                            <div class="card-body">
                                            ...
                                            <table id="datatable-buttons" class="table table-bordered nowrap w-100">
                                                ...
                                                @foreach ($query as $data)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <b><a href="/laporan/produksi/gb/{{ $id }}">{{ dateIndonesia($data->bulan) }}
                                                                    <i
                                                                            class="bx bx-check"
