                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <a href="{{url('laporan/pasok/lpg/periode').'/'.\Illuminate\Support\Facades\Crypt::encrypt($per->badan_usaha_id)}}"
                                        ...
                                        <div class="modal fade" id="modal-update-status" data-bs-backdrop="static"
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ url('/laporan/pasok/lpg/update-revision-all') }}"
                                                        ...
                                                        <div class="modal fade" id="modal-update" data-bs-backdrop="static"
                                                            ...
                                                            <div class="modal-dialog modal-lg">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="{{ url('/laporan/pasok/lpg/update-revision') }}"
                                                                          method="post" id="updateStatusForm"
                                                                          enctype="multipart/form-data">
                                                                        @csrf
            ...
            $('.btn-selesai-status').on('click', function () {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ url('/laporan/pasok/lpg/selesai-periode-all') }}',
                            type: 'POST',
                            data: {
                                _token: '{{ csrf_token() }}',
        ...
        document.querySelectorAll('.btn-selesai').forEach(function(button) {
            ...
            button.addEventListener('click', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ url('/laporan/pasok/lpg/selesai-periode') }}',
                            type: 'POST',
                            data: {
                                _token: '{{ csrf_token() }}',
