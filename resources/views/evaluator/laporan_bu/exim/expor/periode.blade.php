                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div>
                                    <a href="{{url('laporan/expor/exim')}}" class="btn btn-danger btn-sm btn-rounded"><i class='bx bx-arrow-back'></i> Kembali</a>
                                </div>
                                </div>
                            </div>
                            <div class="card-body">
                                            ...
                                            <table id="datatable-buttons" class="table table-bordered nowrap w-100">
                                                ...
                                                @foreach ($query as $data)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <b><a href="/laporan/expor/exim/{{ $id }}">{{ dateIndonesia($data->bulan_peb) }}
                                                                    <i
                                                                            class="bx bx-check"
                                                        ...
                                                        @if ($data->status == 1)
                                                            <td>
                                                                ...
                                                                <button class="btn btn-primary btn-rounded btn-sm btn-selesai-status" data-p="{{\Illuminate\Support\Facades\Crypt::encrypt($data->badan_usaha_id)}}" data-b="{{\Illuminate\Support\Facades\Crypt::encrypt($data->bulan_peb)}}"><i
                                                                            class="bx bx-check"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <form action="{{ url('/laporan/expor/exim/update-revision-all') }}"
                                                                                ...
                                                                                <input type="hidden" name="b"
                                                                                       value="{{\Illuminate\Support\Facades\Crypt::encrypt($data->bulan_peb)}}">
