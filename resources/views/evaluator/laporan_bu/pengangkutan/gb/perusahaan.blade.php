                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form id="cetakForm" action="{{url('laporan/pengangkutan/gb/cetak-periode')}}" method="post" >
                                                        @csrf
                                                        <div>
                                                            <div class="mb-3">
                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable-buttons" class="table table-bordered nowrap w-100">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{url('laporan/pengangkutan/gb/periode').'/'. \Illuminate\Support\Facades\Crypt::encrypt($per->id_perusahaan) }}" class="btn btn-primary btn-rounded btn-sm"><i class="bx bx-show"></i> Lihat </a></td>
