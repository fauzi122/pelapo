            ...
            <div class="navbar-brand-box">
                ...
                <a href="index.html" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        ...
                        <img src="{{ asset('assets/images/logo-sm.svg')}}" alt="" height="24"> <span class="logo-txt">Pelaporan Migas</span>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    @if (Auth::user()->role == 'BU')
                        <a class="dropdown-item" href="{{ url('/logoutBU') }}"><i class="mdi mdi-logout font-size-16 align-middle me-1"></i> Logout</a>
                    @else
