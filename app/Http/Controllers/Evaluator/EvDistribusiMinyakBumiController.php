...
class EvDistribusiMinyakBumiController extends Controller
{
    public function index(){
        ...
        $data = [
            'title'=>'Laporan Minyak Bumi Distribusi',
            'perusahaan' => $perusahaan,
        ];

        return view('evaluator.laporan_bu.mb.distribusi.index',$data);
    }
    ...
    public function cetakperiode(Request $request)
    {
        ...
        if ($result->isEmpty()) {
            ...
            $view = view('evaluator.laporan_bu.mb.distribusi.cetak', $data);
...
//        var_dump($query);die();
        ...
        return view('evaluator.laporan_bu.mb.distribusi.pilihbulan', $data);
