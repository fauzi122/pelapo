...
return new class extends Migration
{
    ...
    {
        Schema::create('penyminyakbumis', function (Blueprint $table) {
            $table->id();
            $table->string('bulan', 20);
            $table->string('jenis_fasilitas', 20);
            $table->string('no_tangki', 20);
            $table->string('jenis_komoditas', 20);
            $table->string('produk', 20);
            $table->string('kab_kota', 20);
            $table->string('kategori_supplai', 20);
    ...
    {
        Schema::dropIfExists('penyminyakbumis');
    }
};
